...
public class Main {
    public static void main(String[] args) throws Exception {
      FileInputStream fis=new FileInputStream("C:\\Users\\Madhubala S C\\Desktop\\code+high+peak\\Input\\input.txt");       
      ...
      FileWriter fw = new FileWriter("C:\\Users\\Madhubala S C\\Desktop\\code+high+peak\\Output\\output.txt");
